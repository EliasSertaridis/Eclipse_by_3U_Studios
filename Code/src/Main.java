...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        PlayableCharacter takhs = new PlayableCharacter("Takhs",12,20,9,40,80,7,3009,19,230.4);
        ...
        BuffPotion bp1=new BuffPotion("Milk","makes you stronger", Item.rarityType.Legendary,3, BuffPotion.StatForModifing.STR);
