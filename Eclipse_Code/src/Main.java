...
public class Main {
    ...
    /*   List<Equipment> equipment = eq1.getCurrentEquipment();
        ...
        */
        ...
        Armor knightHead1 = new Armor("knightHead1","Good", Item.rarityType.Common,2, Armor.TypeOfArmor.Head,2);
        Armor knightChest1 = new Armor("knightChest1", "Good", Item.rarityType.Common,5, Armor.TypeOfArmor.Chest,5);
        Armor knightHands1 = new Armor("knightHands1","Good", Item.rarityType.Common,1, Armor.TypeOfArmor.Hands,1);
        Armor knightLegs1 = new Armor("knightLegs1", "Good", Item.rarityType.Common,3, Armor.TypeOfArmor.Legs,3);
        Weapon knightweap1 = new Weapon("broadsword","Good", Item.rarityType.Common,2,6,0.2, Weapon.TypeOfDamage.Slashing, Weapon.TypeOfWeapon.Sword, Weapon.TypeOfScaling.STR);
        Weapon knightweap2 = new Weapon("longsword","Good", Item.rarityType.Common,3,7,0.2, Weapon.TypeOfDamage.Slashing, Weapon.TypeOfWeapon.Sword, Weapon.TypeOfScaling.STR);
        Weapon knightweap3 = new Weapon("Halberd", "Good", Item.rarityType.Common,5,8,0.3, Weapon.TypeOfDamage.Piercing, Weapon.TypeOfWeapon.Spear, Weapon.TypeOfScaling.DEX);
        Weapon knightweap4 = new Weapon("Hammer","Good", Item.rarityType.Common,1,3,0.6, Weapon.TypeOfDamage.Slashing,)
        Class claSSss=new Class();
        PlayableCharacter pc = new PlayableCharacter();
        pc.setPc_class(claSSss);
        claSSss.setStartingEquipment(Class.armorSetPiece.Head,knightHead1, Class.classType.Knight,1);
        claSSss.setStartingEquipment(Class.armorSetPiece.Chest,knightChest1, Class.classType.Knight,1);
        claSSss.setStartingEquipment(Class.armorSetPiece.Hands,knightHands1, Class.classType.Knight,1);
        claSSss.setStartingEquipment(Class.armorSetPiece.Legs,knightLegs1, Class.classType.Knight,1);
